...
" Resove errors about E484: Can't open file /tmp/vUPw0po/0
set shell=/bin/bash

" change highlight color:fg=black, bg=darkred
...
" show shady characters:tabs, trailing white spaces.
set listchars=tab:>~,nbsp:_,trail:.
set list

" eliminate extra spaces when paste code info C file. When pasting code enter F3
set pastetoggle=<F3>
"""""""""""""""""""""""""""""""""""""""""""""
...
set wildignore+=*.so,*.o,*.swp,*.zip,*gz,*bz2
